...
# |dx| != radius
execute unless score #bb.ts.|dx| bb.variable = #bb.ts.radius bb.variable run function boomber:tree_simulator/algorithm/default/check/leaves

# |dz| != radius
execute if score #bb.ts.|dx| bb.variable = #bb.ts.radius bb.variable unless score #bb.ts.|dz| bb.variable = #bb.ts.radius bb.variable run function boomber:tree_simulator/algorithm/default/check/leaves
