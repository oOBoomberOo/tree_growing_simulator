execute if score #bb.ts.input bb.variable matches 2 run function boomber:tree_simulator/math/rand_int/2
execute if score #bb.ts.input bb.variable matches 3 run function boomber:tree_simulator/math/rand_int/3
