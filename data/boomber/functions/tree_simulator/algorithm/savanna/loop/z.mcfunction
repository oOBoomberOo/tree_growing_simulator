...
execute unless score #bb.ts.|x| bb.variable matches 3 run scoreboard players set #bb.ts.condition bb.success 1
execute unless score #bb.ts.|z| bb.variable matches 3 run scoreboard players set #bb.ts.condition bb.success 1
...
execute if score #bb.ts.z_min bb.variable <= #bb.ts.z bb.variable if score #bb.ts.z bb.variable <= #bb.ts.z_max bb.variable positioned ~ ~ ~1 run function boomber:tree_simulator/algorithm/savanna/loop/z